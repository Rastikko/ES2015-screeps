...
var _thechoosenone = require('thechoosenone');

var _thechoosenone2 = _interopRequireDefault(_thechoosenone);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports.loop = function () {

  var spammer = new _spammer2.default('placeholder');
  ...
  for (var name in Game.creeps) {
    ...
    if (creep.memory.role === 'thechoosenone') {
      (0, _thechoosenone2.default)(creep);
    }
